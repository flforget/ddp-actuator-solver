...
RomeoTorqueActuator::stateMat_t
RomeoTorqueActuator::computeTensorContxx
(const stateVec_t& )
{
    return QxxCont;
}

RomeoTorqueActuator::commandMat_t
RomeoTorqueActuator::computeTensorContuu
(const stateVec_t& )
{
    return QuuCont;
}

RomeoTorqueActuator::commandR_stateC_t
RomeoTorqueActuator::computeTensorContux
(const stateVec_t& )
{
    return QuxCont;
}
