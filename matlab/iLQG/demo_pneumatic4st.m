...
T       = 200;              % horizon
x0      = [0.1;0;0.2e5;3.8e5];   % initial state
...
goal = [0.2;0;0.4e5;3.6e5];
final = isnan(u(1,:));
u(:,final)  = 0;

cu  = 1*1e-2*[0.01 .01];         % control cost coefficients

cf  = 1e-2*[ 1  1 1 1];    % final cost coefficients
%pf  = [.01 .01.01 0 1 0]';    % smoothness scales for final cost

cx  = 1e-3*[1 1 1 1 ];          % running cost coefficients
